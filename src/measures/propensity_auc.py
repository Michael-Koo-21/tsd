...
if __name__ == "__main__":
    ...
    print(f"\nInterpretation:")
    print(f"  - AUC = 0.5 means perfect indistinguishability")
    print(f"  - AUC = 1.0 means easily distinguishable")
    print(f"  - Fidelity = 1.0 means perfect fidelity (AUC=0.5)")
    print(f"  - Fidelity = 0.0 means poor fidelity (AUC=1.0)")
