...
if __name__ == "__main__":
    ...
    print(f"\nInterpretation:")
    print(f"  - Attack Success Rate = 0.5 means attacker is guessing randomly (perfect privacy)")
    print(f"  - Attack Success Rate = 1.0 means attacker always predicts 'member' (worst privacy)")
    print(f"  - Privacy Score = 1.0 means perfect privacy (attack success = 0.5)")
    print(f"  - Privacy Score = 0.0 means no privacy (attack success = 1.0 or 0.0)")

    print(f"\nCurrent results suggest:")
    if result['privacy_score'] > 0.8:
        print(f"  ✓ Excellent privacy - synthetic data doesn't reveal training membership")
    elif result['privacy_score'] > 0.6:
        print(f"  ✓ Good privacy - synthetic data has limited training memorization")
    elif result['privacy_score'] > 0.4:
        print(f"  ⚠ Moderate privacy - some training memorization detected")
    else:
        print(f"  ⚠ Poor privacy - significant training memorization")
