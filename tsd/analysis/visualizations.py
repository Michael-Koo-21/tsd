...
def pareto_frontier(df: pd.DataFrame, output_dir: Path) -> Path:
    ...
    points = [
        (summary.loc[m, "fidelity_auc"], summary.loc[m, "utility_tstr"], m) for m in summary.index
    ]
    ...
    for p in pareto_points:
        ax.scatter(p[0], p[1], s=300, facecolors="none", edgecolors="gold", linewidth=3, zorder=4)
